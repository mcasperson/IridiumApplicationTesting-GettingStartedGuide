...
## Java Web Start (JNLP)
 ...
 Note that you must trust the GitHub URL that hosts the example JAR files for these Web Start examples to work properly. See the Installation chapter for more details.
 ...
 5. [Data Set Collections](https://github.com/AutoGeneral/IridiumApplicationTesting/blob/master/examples/5.dataset/test.jnlp) ([code](https://github.com/AutoGeneral/IridiumApplicationTesting/tree/master/examples/5.dataset))
 ...
 7. [Tags](https://github.com/AutoGeneral/IridiumApplicationTesting/blob/master/examples/7.tags/test.jnlp) ([code](https://github.com/AutoGeneral/IridiumApplicationTesting/tree/master/examples/7.tags))
